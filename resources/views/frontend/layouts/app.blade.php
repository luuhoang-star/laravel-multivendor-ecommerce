...
<head>
    <meta charset="utf-8" />
    <title>ShopX - Mẫu thương mại điện tử đa năng</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12">
                            <div class="detail-info pr-30 pl-30">
                                ...
                                <div class="font-xs">
                                    <ul>
                                        <li class="mb-5">Nhà cung cấp: <span class="text-brand">ShopX</span></li>
                                        <li class="mb-5">Ngày sản xuất:<span class="text-brand"> 4/6/2025</span></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- Detail Info -->
