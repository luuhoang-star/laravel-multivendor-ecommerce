       ...
       <div class="container">
           <div class="row">
               <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                   data-wow-delay="0">
                   <h4 class="section-title style-1 mb-30 animated animated">Bán chạy nhất</h4>
               ...
               <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                   data-wow-delay=".1s">
                   <h4 class="section-title style-1 mb-30 animated animated">Sản phẩm xu hướng</h4>
                   <div class="product-list-small animated animated">
                       <article class="row align-items-center hover-up">
                           <figure class="col-sm-4 mb-0">
               ...
               <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                   data-wow-delay=".2s">
                   <h4 class="section-title style-1 mb-30 animated animated">Mới thêm gần đây</h4>
                   <div class="product-list-small animated animated">
                       <article class="row align-items-center hover-up">
                           <figure class="col-sm-4 mb-0">
               ...
               <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                   data-wow-delay=".3s">
                   <h4 class="section-title style-1 mb-30 animated animated">Được đánh giá cao</h4>
                   <div class="product-list-small animated animated">
                       <article class="row align-items-center hover-up">
                           <figure class="col-sm-4 mb-0">
