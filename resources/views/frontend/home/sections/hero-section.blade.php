                            ...
                            <div class="hero-slider-1 style-5 dot-style-1 dot-style-1-position-2">
                                <div class="single-hero-slider single-animation-wrap"
                                    ...
                                    <div class="slider-content">
                                        <h1 class="display-2 mb-15">Đồng hồ thông minh có bộ theo dõi nhịp tim</h1>
                                        <p>Thời trang và công nghệ kết hợp trong một sản phẩm hiện đại.</p>
                                        <a href="shop-grid-right.html" class="btn">Mua ngay <i
                                ...
                                <div class="single-hero-slider single-animation-wrap"
                                    ...
                                    <div class="slider-content">
                                        <h1 class="display-2 mb-15">Tai nghe Bluetooth không dây</h1>
                                        <p>Âm thanh chất lượng cao, kết nối tiện lợi và thời trang.</p>
                                        <a href="shop-grid-right.html" class="btn">Mua ngay <i
                                                class="fi-rs-arrow-small-right"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-12">
                                <div class="banner-img style-4 mt-30">
                                    ...
                                    <div class="banner-text">
                                        <h4 class="mb-30">Tai nghe âm thanh độ nét cao</h4>
                                        <a href="shop-grid-right.html" class="btn btn-xs mb-50">Mua ngay <i
                                                class="fi-rs-arrow-small-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-lg-12">
                                <div class="banner-img style-5 mt-5 mt-md-30">
                                    ...
                                    <div class="banner-text">
                                        <h5 class="mb-20">Giày boots da nam <br> chống nước</h5>
