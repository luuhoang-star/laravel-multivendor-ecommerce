...
<head>
    ...
    <title>Đặt lại mật khẩu</title> <!-- BEGIN GLOBAL MANDATORY STYLES -->
                    ...
                    <form action="{{ route('admin.password.store') }}" method="post" autocomplete="off" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" name="email" value="{{ old('email', $request->email) }}"
                                class="form-control" placeholder="superadmin@email.com" autocomplete="off" />
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group input-group-flat">
                                <input type="password" name="password" class="form-control"
                                    placeholder="Mật khẩu của bạn" autocomplete="off" />
