...
<head>
    ...
    <title>Quên mật khẩu</title> <!-- BEGIN GLOBAL MANDATORY STYLES -->
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <div class="card card-md">
                <div class="card-body">
                    <p>
                        {{ __('Quên mật khẩu? Hãy nhập địa chỉ email của bạn. Chúng tôi sẽ gửi cho bạn một liên kết để đặt lại mật khẩu, giúp bạn tạo mật khẩu mới.') }}
                    </p>
                    ...
                    <form action="{{ route('admin.password.email') }}" method="post" autocomplete="off" novalidate>
                        ...
                        <div class="form-footer">
                            <button type="submit" class="btn btn-primary w-100"> {{ __('Gửi liên kết đặt lại mật khẩu qua email.') }}</button>
                        </div>
                    </form>
                </div>
